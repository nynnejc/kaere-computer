        ...
        <div>
          ...
          <div className="py-4">
            <p>
              ...
              circle(x, y, d). With the parameters: <b>x</b>{" "}
              coordinate of the center of the circle, <b>y</b> coordinate
              of the center of the circle and <b>d</b> diameter of the circle.
            </p>
          </div>
          ...
          <div className="py-4">
            <p>
              ...
              position of the center of the flower. <br></br>petalSize holds the
              diameter of the petals. petalDistance holds the space between the
              center of the flower and the four orange petals. Notice that this
              line uses the petalSize variable to calculate its value!{" "}
              <a
          ...
          <div className="py-4">
            <p>
              ...
              time, let us take a look at how it looks to add the last three petals to our
              flower.
            </p>
          </div>
