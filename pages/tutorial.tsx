...
export default function Tutorial() {
  return (
    <body className="flex flex-col min-h-screen  bg-pistacio_kc selection:bg-pink-300">
      <Navbar />

      <main className="flex-grow mt-2 pr-80">
        <div>
          <h1 className="font-mono mb-4 ml-6">Tutorial</h1>

          <h5 className="ml-6 custom-font-dauphine">
            Softer Intro to Creative Coding
          </h5>

          <div className="ml-24 mr-80">
            <div className="pt-16 py-4">
              <p>
                This is an intro course to programming with the P5js library
                made for the{" "}
                <a
            ...
            <div className="py-4">
              <p>
                One of the things that make p5.js beginner-friendly is that it
            ...
            <div>
              <p>
                ...
                already written. In the right pane, you see something like a
                piece of paper. Everything we draw will appear on it!
              </p>
            </div>
            ...
            <div className="py-4">
              <p>
                ...
                see the result in the preview section on the right and so far
                all this code does is create a drawing canvas and give it a grey
                background.
              </p>
            </div>
            ...
            <div className="py-4">
              <p>
                A <b>function</b> is a block of code that can be called again
                and again because it has a name. Always write the keyword{" "}
            ...
            <div className="py-4">
              <p>
                ...
                to define the screen size and background color. A little bit
                like the paper you draw on. If you want to learn more about it,
                you can read about this function in the p5.js documentation
                <a
            ...
            <div className="py-4">
              <p>
                ...
                setup() function and this is where you define code that runt
                until the program is stopped again. There can only be one deaw()
            ...
            <div className="py-4">
              <p>
                ...
                which also runs your code and shows it directly on this site!
                Very neat, but I want you to still go back to the other tab
                where you kept the standalone p5.js editor since it will save
                your work and make it easy to share.
              </p>
            </div>
            ...
            <div className="py-4">
              <p>
                ...
                editor, circle(200, 200, 300);, which we want to make sure to
                add inside the draw() function. Notice the circle() function
                takes three arguments (200, 200, 300). Make sure your semicolons
                and curly brackets are all in order, and then click the play
                button again. Now you should see this:
              </p>
            </div>
            ...
            <div className="py-4">
              <p>
                We just learned about functions and how these are reusable
                blocks of code that we can call using their names. Next you need
                to learn about variables. Variables are for storing values and
                data for later use, and can also be accessed again using their
                names. Use the <b>var</b> keyword before giving it a name and
                add the value after assigning it with the <b>=</b> sign.
              </p>
            </div>
            ...
            <div className="py-4">
              <p>
                ...
                . To create a variable, we use the <em>let</em> keyword to
            ...
            <div className="py-4">
              <p>
                ...
                In the draw function, we set the background to a lilac color
                (with the RGB code 245, 220, 252). Notice that we set variables
                for the circles x and y coordinates as well as its diameter. The
                use of nostroke is to makes sure that the circle does not have
                any black border. Leave this line out if you like the look of
                the border. It should look{" "}
                <a
            ...
            <div className="py-4">
              <p>
                Next we want to start creating the variables we need to vreate
                our softer flower. <br></br> flowerX holds the horizontal
                position of the center of the flower. <br></br> flowerY holds
                the vertical position of the center of the flower. <br></br>
            ...
            <div className="py-4">
              <p>
                ...
                comments that the cumputer will skip instead of reading and
                trying to execute. This is the way to annotate the code, i.e.
                make comments for making the code clearer to ourselves.
              </p>
            </div>

            <div className="py-4">
              <p>
                Next we want to add a petal! We will add all the petals above
                the code that creates the center petal. If anything goes wrong,
                check your code{" "}
                <a
                  href="https://editor.p5js.org/nynnejc/sketches/QkLU8-0Km"
                  target="_blank"
            ...
            <div className="py-4">
              <p>
                Skipping criminally far ahead in order to finish this tutorial
                in time, let us take a look at how it looks to add the last
                three petals to our flower.
              </p>
            </div>
            ...
            <div className="py-4">
              <p>
                ...
                means that you can use them without importing a library. These
                can also be thought of as built-in methods that comes
                automatically with the framework.
              </p>
            </div>
              ...
              <div className="pt-6">
                ...
                <p>
                  ...
                  >
                    ...
                    <em>
                      Beginner-friendly and extensive p5.js tutorial page.
                    </em>
                  </a>
                </p>
                ...
                <p>
                  ...
                  >
                    The Coding Train *{" "}
                    <em>
                      Beginner-friendly youtube videos on creative coding.
                    </em>
                  </a>
                </p>
