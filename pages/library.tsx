...
export default function About() {
  return (
    <div className="bg-yellow_kc flex flex-col min-h-screen selection:bg-pink_kc">
      <body>
        <Navbar />

        <main className="flex-grow mx-auto flex flex-col">
          <h1 className="font-mono mb-4 ml-6">Resource Library</h1>

          <h5 className="ml-6 custom-font-dauphine">Envolving list to encourage the new programmer</h5>
                ...
                <p>
                  ...
                  >
                    ...
                    <em>
                      ...
                      direcyly in the glitch editor without having to mess
                      around with the setup.
                    </em>
                  </a>
                </p>
